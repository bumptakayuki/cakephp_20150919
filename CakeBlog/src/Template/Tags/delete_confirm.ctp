<?php $this->request->session()->write('data.id',$tag->tag_id); ?>
<h1>確認画面</h1>
...
<div class="Posts view large-10 medium-9 columns">
    ...
    <div class="Posts view large-5 medium-5 columns">
        <!-- form部分 -->
    <div id="submit-button-area">
        <?= $this->Form->create($tag,['url' => ['controller' => 'tags','action' => 'deleteFinish']])?>
